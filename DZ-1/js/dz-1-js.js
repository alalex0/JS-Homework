...
console.log(Y, "значение Y");
 ...
 /*5. Вывести в консоль ближайшее к 10 из двух чисел, 
 записанных в переменные m и n.
  Например, среди чисел 8.5 и 11.45 ближайшее к десяти 11.45.*/

 let m = 11.4;
 let n = 11.0;
 let m1 = Math.abs(parseFloat(m) - 10);
 let n1 = Math.abs(parseFloat(n) - 10);
  res = (m1 - n1 === 0)? "числа равноудалены" : (m1 > n1)? n : m;
console.log(res);
